...
MONGO_CONNECT_URL = f'mongodb://admin:admin1234@127.0.0.1:27017/admin'  # 如果有密码连接 'mongodb://myUserAdmin:8mwTdy1klnSYepNo@192.168.199.202:27016/admin'
...
KOMBU_URL = 'redis://redismod:6379/0'
